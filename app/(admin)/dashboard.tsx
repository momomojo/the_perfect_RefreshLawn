...
const AdminDashboard = () => {
  ...
  return (
    <RoleGuard allowedRoles={["admin"]} redirectPath="/unauthorized">
          ...
          <View className="p-4">
            ...
            <View className="bg-purple-100 p-4 rounded-lg mb-6 border border-purple-300">
              ...
              <Text className="text-purple-700">
                The RoleGuard component is protecting this route by checking the
                user's role in the JWT token claims. If a non-admin user tries
                to access this page, they will be redirected.
              </Text>
            ...
            <View className="mb-6">
              ...
              <View className="bg-white border border-gray-200 rounded-lg p-4">
                <Text className="text-gray-700">
                  User management tools would appear here, allowing
                  administrators to view and manage technicians and customers.
                </Text>
              </View>
            </View>
