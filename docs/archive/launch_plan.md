...
1. **Modify BookingForm to use Stripe's PaymentSheet**
   ...
   - Add UI components for payment states (loading, success, error) in the BookingForm:
     ...
     {
       paymentInProgress && (
         <View className="mb-4 items-center rounded-lg bg-gray-50 p-4">
     ...
     }
     {
       paymentError && (
         <View className="mb-4 rounded-lg bg-red-50 p-4">
           <Text className="font-medium text-red-700">Payment Error</Text>
           <Text className="mt-1 text-red-600">{paymentError}</Text>
           <TouchableOpacity
             className="mt-3 self-start rounded-md border border-red-300 bg-white px-4 py-2"
