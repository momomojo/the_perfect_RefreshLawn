...
-- Migration to fix update_booking_status function signature and notification calls
...
BEGIN
  ...
  BEGIN
    ...
    v_notification_message := 'Your booking (ID: ' || left(p_booking_id::text,8) || ') status is now ' || p_new_status || '.';
